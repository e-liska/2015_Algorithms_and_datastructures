...
public class E1App {
	public static void main(String[] args) {
		...
		System.out.println("Insert name of a team");
		...
		// String selectedTeam = "Atlanta";

		E1 e = new E1(league, selectedTeam);
		if (e.isEliminated()) {
			System.out.println("Team " + selectedTeam + " is eliminated.");
		} else {
			System.out.println("Team " + selectedTeam
					+ " is not eliminated and still has a chance.");
		}
	}
}
